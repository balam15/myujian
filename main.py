...
SECRET_KEY = "1a2f221f508b0bfaee1fc8482ae0a514493c2dbf954fd03d65a8943e3285feb8"
ALGORITHM = "HS256"
...
fake_users_db = {
    "asdf": {
        ...
        "hashed_password": "$2a$05$Xfh80RX8n.jid2rXLzahSO465pfA1DZxFnhwBvrsMBYiIdvw1Xz32",
        "disabled": False,
    }
}
...
async def add_menu(item_id: int, name:str, current_user: User = Depends(get_current_active_user)):
    for menu_item in data['menu']:
        if menu_item['id'] == item_id:
            menu_item['name'] = name
            read_file.close()
